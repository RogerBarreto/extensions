...
public readonly struct AudioTranscriptionResponseUpdateKind : IEquatable<AudioTranscriptionResponseUpdateKind>
{
    ...
    /// <summary>Provides a <see cref="JsonConverter{AudioTranscriptionUpdateKind}"/> for serializing <see cref="AudioTranscriptionResponseUpdateKind"/> instances.</summary>
